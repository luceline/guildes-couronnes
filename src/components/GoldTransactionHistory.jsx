...
const TYPE_COLORS = {
  ...
  vol_chaudron_recu: "bg-green-100 text-green-800",
  vol_chaudron_subi: "bg-red-100 text-red-800",
  razzia_gain: "bg-green-100 text-green-800",
  razzia_loss: "bg-red-100 text-red-800",
