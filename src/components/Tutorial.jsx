...
const STEPS = [
  ...
  },
  {
    ...
    content: "Vos armes et armures ne sont pas éternelles. Chaque pièce équipée dispose de dix points de durabilité au départ. L'usure ne provient pas du temps qui passe : ce sont vos combats qui érodent l'acier.\n\nQuand vous attaquez un autre joueur en duel, votre épée perd un point de durabilité à chaque coup porté, peu importe le résultat. Quand vous êtes attaqué et que vous prenez un coup, l'objet qui défendait la zone touchée perd un point : armure de zone ou bouclier si vous l'aviez placé là. Une parade parfaite ou un coup absorbé sans dégât n'use rien.\n\nÀ zéro point de durabilité, l'item reste dans son emplacement, mais cesse de procurer son bonus d'attaque ou de défense. Il vous regarde tristement, vous rappelant qu'il faut le réparer.\n\nL'entretien se fait grâce à un objet : le Marteau d'armurier, fabriqué par les Mineurs au tier 3. Sa consommation vous offre dix points de réparation à répartir librement entre vos six pièces équipées. Vous décidez où va chaque point : tout sur l'épée, ou cinq sur le bouclier et cinq sur la cuirasse, ou un point partout. Une fois consommé, le marteau est usé : pour entretenir un guerrier complet, prévoyez d'en avoir plusieurs en stock ou nouez de bons rapports avec un Mineur.\n\nLes combats de biome (épopée quotidienne) n'usent rien : seul le PvP entre humains érode votre équipement.",
    tip: "📜 Aldebert vous tend un marteau au manche usé : « Dix coups, et vos peines sont effacées. À vous de choisir où ils tombent : sur la lame qui frappe, sur l'écu qui protège, ou sur les jambières qui vous portent. Un guerrier prudent garde toujours un marteau de rab. »",
  },
  {
    category: "duel",
    icon: "⚔️",
