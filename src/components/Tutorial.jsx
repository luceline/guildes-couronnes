...
const STEPS = [
  ...
  },
  {
    ...
    tip: "📜 Aldebert range son épée : « La parade laisse intact. Le coup non paré coûte un point de vie. Et un combattant à zéro point de vie passe deux jours en convalescence avant de pouvoir repartir au combat. Voilà le vrai prix du sang. »",
  },
  {
    category: "duel",
    icon: "💰",
